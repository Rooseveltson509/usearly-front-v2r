        ...
        <div className={`brand-block ${expanded ? "open" : ""}`}>
            ...
            {expanded && (
                <div className="subcategories-list">
                    {reports.flatMap(report => report.subCategories).map(sub => {
                        ...
                        return (
                            ...
                            >
                                <div className="subcategory-header" onClick={() => toggleSubCategory(sub.subCategory)}>
                                    <img
                                            ...
                                            <div className="description-slide-container">
                                                <div className="slide-content slide">
                                                    <div className="emoji-avatar">
                                                        ...
                                                        <img
                                                            src={currentDesc.user?.avatar ? `${import.meta.env.VITE_API_BASE_URL}/${currentDesc.user.avatar}` : "/default-avatar.png"}
                                                    ...
                                                    <div className="description-text">
                                                        <div className="user-meta">
                                                            ...
                                                            <span className="time">
                                                                ⸱ {formatDistanceToNow(new Date(currentDesc.createdAt), { locale: fr, addSuffix: true })}
                                                            </span>
                                                    ...
                                                    {sub.descriptions.length > 1 && (
                                                        <div className="description-chevrons">
                                                            <div className="navigation">
                                                                <button onClick={() => handlePrev(sub.subCategory)} disabled={currentIndex === 0}>
                                                                    <ChevronLeft size={18} />
                                                                </button>
                                                                <button onClick={() => handleNext(sub.subCategory, sub.descriptions.length)} disabled={currentIndex === sub.descriptions.length - 1}>
