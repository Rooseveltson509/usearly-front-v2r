...
const UserAccount = () => {
  ...
  return (
    <div className="user-account">
      ...
      <Avatar
        avatar={avatarPreview || getFullAvatarUrl(userProfile?.avatar || null)}
        pseudo={avatarPreview || getFullAvatarUrl(userProfile?.avatar || null)}
        type="user"
        className="comment-avatar"
        wrapperClassName="avatar-preview"
      />
