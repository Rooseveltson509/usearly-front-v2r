...
type ChartLegendPayload = LegendPayload[];
type ChartLegendAlign = RechartsPrimitive.LegendProps["verticalAlign"];
...
>(
  (
    ...
    const tooltipPayload = payload as ChartTooltipProps["payload"];
...
type ChartLegendContentProps = React.HTMLAttributes<HTMLDivElement> & {
  ...
  verticalAlign?: ChartLegendAlign;
  hideIcon?: boolean;
  nameKey?: string;
};
...
>(
  (
    ...
    const legendPayload = payload as ChartLegendPayload;
